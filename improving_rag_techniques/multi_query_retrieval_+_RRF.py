...
# Reciprocal Rank Fusion (RRF) is a method that combines multiple ranked chunk lists by giving each chunk a
# score based on its positions across all lists.

# RRF_score = E (1 / (k + rank_position))
