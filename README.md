...
This list will be updated as new concepts are learned.
...
> Split text using simple character/separator rules.

### RecursiveCharacterTextSplitter

> Try larger meaningful separators first, then progressively smaller ones.

### Semantic Chunking

> Use semantic similarity to identify meaningful boundaries.
...
Chunking is therefore one of the most important parts of a RAG pipeline.

---

# RAG Pipeline

The current overall pipeline is:
...
More advanced retrieval and chunking techniques will be added as the learning process continues.
